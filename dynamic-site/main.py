    ...
    def get(self):
        ...
        if self.request.GET:
            ...
            if team == "atlanta":#button to request data
                ...
                page.result = data.eteam_array[2]#sending objects to setter of 3rd array to team link
                ...
                page.result = data.eteam_array[3]#sending objects to setter of 4th array to team link
                ...
                page.result = data.eteam_array[4]#sending objects to setter of 5th array to team link
                ...
                page.result = data.wteam_array[0]#sending objects to setter of 1st array to team link
                ...
                page.result = data.wteam_array[1]#sending objects to setter of 2nd array to team link
                ...
                page.result = data.wteam_array[2]#sending objects to setter of 3rd array to team link
                ...
                page.result = data.wteam_array[3]#sending objects to setter of 4th array to team link
                ...
                page.result = data.wteam_array[4]#sending objects to setter of 5th array to team link
